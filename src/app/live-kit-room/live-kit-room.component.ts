...
export class LiveKitRoomComponent {
  ...
  private initializeStateObservables() {
    ...
    this.liveKitViewState$.subscribe((state) => {
      console.log('starting state is', state.isInitialScreenStarted);
  ...
  async toggleVideo(): Promise<void> {
    ...
    this.joinMeetingComponent.toggleCamera();
  }
  ...
  async toggleMic(): Promise<void> {
    ...
    this.joinMeetingComponent.togglePreviewMic();
  }
  ...
  async createRoomFromSideWindow(): Promise<void> {
    this.store.dispatch(
      LiveKitRoomActions.BreakoutActions.sendBreakoutRoomsInvitation()
    );
  }
...
*/
  ...
  // Updated function for room selection
  onRoomSelection(room: any, participant: any): void {
    // Dispatch action to add participant to the selected room
    this.store.dispatch(
      LiveKitRoomActions.BreakoutActions.addParticipantToRoom({
